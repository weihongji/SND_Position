--spQueryAlarmList 255, -1, -1, 255, '2013-08-14', '2013-08-14 23:59:59'

IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spQueryAlarmList]') AND type in (N'P', N'PC')) BEGIN
	DROP PROCEDURE [dbo].[spQueryAlarmList]
END
GO

CREATE PROCEDURE dbo.spQueryAlarmList
